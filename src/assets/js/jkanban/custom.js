    ...
    boards: [
      {
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">23/7/20</span><span class="badge badge-primary f-right">متوسط</span >
                                   <h6>داشبورد طراحی</h6>
      ...
      },
      {
        ...
        item: [
          ...
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="badge badge-success f-right">کم</span >
                                   <h6>مشکل داشبورد</h6>
                                   <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title=" "title="">
                                     <div class="media-body">
                                       <p>Pixelstrap، نیویورک</p>
                                     </div>
                                   </div>
                                   <div class="d-flex mt-3">
                                     <ul class="list">
    ...
    boards: [
      {
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">24/7/20</span><span class="badge badge-info f-right">متوسط</span >
                                   <h6>نوار کناری تست</h6>
                                   <div class="media"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/3.jpg" alt="" data-original-title=" "title="">
                                     <div class="media-body">
                                       <p>ژاکت، استرالیا</p>
